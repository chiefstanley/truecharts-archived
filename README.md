...
```
cd existing_repo
git remote add origin http://172.16.1.252/netadmin/truecharts_archived.git
git branch -M main
...
- [ ] [Set up project integrations](http://172.16.1.252/netadmin/truecharts_archived/-/settings/integrations)
